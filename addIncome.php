						...
						<nav class = "navbar navbar-dark navbar-expand-lg myNavbar">
							...
							<div class = "collapse navbar-collapse" id = "friendlyUserMenu">
								...
								<ul class = "navbar-nav mx-auto">
									...
									<li class = "nav-item myNavItem">
										<a class = "nav-link active myActive" href = "add-income">Add income</a>
									</li>
									<li class = "nav-item myNavItem">
									...
									<div class = "col-12">
										...
										<div class = "transferFormContainer">
											...
											<form>
												...
												<div class = "col-12 col-md-7 col-lg-5" style = "float: left;">
												
													<div class = "col-12 categoryIncome">
												...
												<div class = "col-12 col-md-5 col-lg-7" style = "float: left;">
																								
													<div class = "col-12 amountAndDateIncome">
														<input class = "form-control transferFormIncome" type = "number" step = 0.01 placeholder = "amount" required>					
														<input class = "form-control transferFormIncome" type = "date" required>
													</div>
													<div style = "clear:both;"></div>
													
													<div class = "col-12 textAreaIncome">
														
														<textArea class = "form-control textAreaIncome" placeholder = "comment (optional)"></textArea>
